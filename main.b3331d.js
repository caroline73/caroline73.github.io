...
function(e) {
    ...
    0 : function(e, t, n) {
        ...
        a = n(192),
        u = o(a),
        l = n(129); (0, l.addLoadEvent)(function() {
            u.
        default.init(),
            i.
        default.init()
  ...
  * Copyright (c) 2017 Dmitry Semenov; */
        ...
        function() {
            ...
            var e = function(e, t) {
                ...
                D = function() {
                    return T = !T,
                    T ? (t.removeClass(l, "pswp__share-modal--fade-in"), setTimeout(function() {
                        T && k()
                    },
                ...
                M = function(t) {
                    ...
                    !!n.href && ( !! n.hasAttribute("download") || (window.open(n.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), T || D(), !1))
                },
                A = function() {
                    for (var e, t, n, o, r, i = "",
  ...
  * Copyright (c) 2017 Dmitry Semenov; */
        ...
        function() {
            ...
            var e = function(e, t, n, o) {
                ...
                Me = function(e, t, n, o, r) { (!Te || r && r !== i.currItem) && (o /= r ? r.fitRatio: i.currItem.fitRatio),
                ...
                rt = {
                    ...
                    init: function() {
                        if (!s && !c) {
                            ...
                            Oe("initialZoomInEnd",
                            function() {
                                i.setContent(T[0], p - 1),
                                i.setContent(T[2], p + 1),
                    ...
                    updateSize: function(t) {
                        ...
                        if (ve.x = i.scrollWrap.clientWidth, ve.y = i.scrollWrap.clientHeight, Xe(), we.x = ve.x + Math.round(ve.x * l.spacing), we.y = ve.y, Le(we.x * ye), Re("beforeResize"), void 0 !== m) {
                            for (var o, a, s, c = 0; c < u; c++) o = T[c],
                            Pe((c + m) * we.x, o.el.style),
                            s = p + c - 1,
                            l.loop && en() > 2 && (s = Ee(s)),
                            a = Qt(s),
                            ...
                            a && a.container && (sn(a, ve), dn(a), Fe(a));
                            S = !1
                        }
                        w = g = i.currItem.initialZoomLevel,
                        oe = i.currItem.bounds,
                    ...
                    zoomTo: function(e, t, n, o, i) {
                        ...
                        Ze(u);
                        var c = function(t) {
                            1 === t ? (g = e, he.x = u.x, he.y = u.y) : (g = (e - l) * t + l, he.x = (u.x - s.x) * t + s.x, he.y = (u.y - s.y) * t + s.y),
                            i && i(t),
                            Ae(1 === t)
                        };
                ...
                Ut = function(e) {
                    if (! ("mousedown" === e.type && e.button > 0)) {
                        ...
                        if (!J || "mousedown" !== e.type) {
                            ...
                            Q = null,
                            nt(),
                            H && 1 !== o || (H = ue = !0, r.bind(window, h, i), W = ce = le = K = $ = V = G = Y = !1, ae = null, Re("firstTouchStart", n), Ne(me, he), de.x = de.y = 0, Ne(ct, n[0]), Ne(ft, ct), dt.x = we.x * ye, mt = [{
                                x: ct.x,
                                y: ct.y
                            }], B = z = ke(), We(g, !0), It(), Et()),
                            !ee && o > 1 && !ie && !$ && (w = g, Y = !1, ee = G = !0, de.y = de.x = 0, Ne(me, he), Ne(ut, n[0]), Ne(lt, n[1]), Mt(ut, lt, bt), xt.x = Math.abs(bt.x) - he.x, xt.y = Math.abs(bt.y) - he.y, te = ne = Tt(ut, lt))
                        }
                    }
                },
                zt = function(e) {
                ...
                Jt = function(e, t) {
                    ...
                    var c, f = we.x * ye,
                    d = Math.abs(f - wt.x);
                    return n || f > wt.x == t.lastFlickSpeed.x > 0 ? (c = Math.abs(t.lastFlickSpeed.x) > 0 ? d / Math.abs(t.lastFlickSpeed.x) : 333, c = Math.min(c, 400), c = Math.max(c, 250)) : c = 333,
                    vt === p && (n = !1),
                    ie = !0,
                    Re("mainScrollAnimStart"),
                    ot("mainScroll", wt.x, f, c, r.easing.cubic.out, Le,
                    function() {
                        nt(),
                        ie = !1,
                        vt = -1,
                ...
                var Yt, Vt, Xt, $t, Qt, en, tn, nn = function(t, n, o, a) {
                    ...
                    if (!s || !u || void 0 === u.x) return Re("initialZoom" + (o ? "Out": "In")),
                    ...
                    publicMethods: {
                        initHistory: function() {
                            if (r.extend(l, Dn, !0), l.history) {
                                ...
                                var e = function() {
                                    Tn = !0,
                                    _n || (On ? history.back() : In ? Rn.hash = In: kn ? history.pushState("", document.title, Rn.pathname + Rn.search) : Rn.hash = ""),
                                    An()
                                };
                                Oe("unbindEvents",
                                function() {
